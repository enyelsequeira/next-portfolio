  ...
  return (
    <div className="flex-col md:flex md:flex-row justify-between p-4">
      ...
      <div className="mb-5 md:mb-0  w-full md:w-2/4 font-display p-4 md:p-6 lg:self-center">
        <h2 className="text-5xl md:text-6xl lg:text-7xl text-t-primary font-body dark:text-d-t-base tracking-wider">Hello, I'm</h2>
        ...
        <p className="font-body text-2xl md:text-3xl ">Full-Stack Developer</p>
      </div>

      <div className="w-full md:w-2/4 p-2 md:p-6 ">
