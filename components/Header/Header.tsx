            ...
            <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
              ...
              <div className={"lg:flex flex-grow items-center" +(menuOpen ? " flex" : " hidden")}
                ...
                <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                  ...
                  <li className="nav-item">
                    <Link href="/contact">
                      <a className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug hover:opacity-75 border bg-yellow-200  rounded-2xl text-white dark:text-black">
                        Contact
                      </a>
                    </Link>
                  </li>
